...
<body>
	...
	<form action="addSubject" method="post">
		<div class="form-group">
			<label for="exampleInputEmail1">Name of Subject</label> <input
				type="text" class="form-control" id="exampleInputEmail1"
				name="subname" aria-describedby="emailHelp"
		...
		<div class="form-group">
			<label for="Branch">Choose a Branch:</label> <select name="b_Id"
				id="branch">
